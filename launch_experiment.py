...
def evaluation(args):
    ...
    assert 'grid' in configs_dict or 'random' in configs_dict

    search_class = (Grid if 'grid' in configs_dict else RandomSearch)
    ...
    risk_assesser = RiskAssesser(outer_folds, inner_folds, experiment_class, exp_path, splits_folder, data_splits_filepath, search,
