...
from model.dgn.cgmm import CGMMTransition, BaseTransition
...
class ECGMM(torch.nn.Module):
    ...
    def e_step(self, data, extra=None):
        ...
        if self.compute_intermediate_outputs:
            ...
            embeddings = (node_embeddings_batch, edge_embeddings_batch, graph_embeddings_batch, node_statistics_batch, edge_statistics_batch, None)
        else:
            embeddings = None
