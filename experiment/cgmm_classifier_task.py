...
from experiment.incremental_task import CGMMTask
...
class ClassifierCGMMTask(CGMMTask):
    ...
    def run_valid(self, dataset_getter, logger):
        ...
        base_path = os.path.join(embeddings_folder, dataset_getter.dataset_name, f'{max_layers}_{unibigram}_{C}_{CA}_{aggregation}_{infer_with_posterior}_{outer_k+1}_{inner_k+1}')
